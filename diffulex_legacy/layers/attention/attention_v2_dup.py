...
class Attention(nn.Module):
    ...
    def dllm_block_mask(
        ...
        num_computing_blocks = [seq.num_diffusion_blocks - num_cached_blocks[idx] for idx, seq in enumerate(seqs)]
        ...
        return create_block_mask(dllm_document_block_wise_causal_mask, B, H, Q_LEN, KV_LEN, device=device)

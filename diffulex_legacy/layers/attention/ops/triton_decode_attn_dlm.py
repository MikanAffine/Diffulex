...
def dlm_flash_decoding_kernel(
    ...
    block_tables_stride_nseqs,
    block_tables_stride_nblks,
    cu_seqlens_q_ptr_stride,
    total_lens_ptr_stride,
    ctx_lens_ptr_stride,
    ...
    NUM_UNROLL_CACHE: tl.constexpr = 4,
    NUM_UNROLL_Q: tl.constexpr = 1,
):
    pass


def diffusion_lm_flash_decoding(
    q: torch.Tensor,
    k: torch.Tensor,
    v: torch.Tensor,
    mask: torch.Tensor,

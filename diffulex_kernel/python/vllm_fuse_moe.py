...
try:
    # vLLM 0.10.x path used by dInfer.
    from vllm.utils import direct_register_custom_op
except ImportError:
    # Newer vLLM moved this helper.
...
def fused_experts_impl(hidden_states: torch.Tensor,
    ...
    try:
        # vLLM 0.10.x name used by dInfer.
        CHUNK_SIZE = envs.VLLM_FUSED_MOE_CHUNK_SIZE
    except AttributeError:
        # Newer vLLM renamed the MoE chunk-size env.
        CHUNK_SIZE = getattr(envs, "VLLM_MOE_DP_CHUNK_SIZE", 256)

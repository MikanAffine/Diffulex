#!/usr/bin/env python3
"""测试FP8 KV cache：使用FP8存储，在Python层显式反量化为BF16，然后用原来的BF16算子"""
...
def main():
    ...
    print("=" * 60)
    print("初始化 Diffulex 模型 (FP8 KV Cache)...")
    print("=" * 60)
    ...
    print("使用FP8 KV cache，Python层反量化为BF16后使用BF16算子")
    print("=" * 60)
    ...
    print("\n✓ FP8 KV Cache (Python层反量化) 端到端测试完成！")
